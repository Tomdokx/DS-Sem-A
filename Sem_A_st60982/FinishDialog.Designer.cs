...
namespace Sem_A_st60982
{
	partial class FinishDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Finish length";
			// 
			// label2
			// 
			...
			this.radioButton1.Location = new System.Drawing.Point(129, 88);
			this.radioButton1.Name = "radioButton1";
			this.radioButton1.Size = new System.Drawing.Size(109, 24);
			this.radioButton1.TabIndex = 8;
			this.radioButton1.TabStop = true;
			this.radioButton1.Text = "From Origin";
			this.radioButton1.UseVisualStyleBackColor = true;
			// 
			// radioButton2
			// 
			this.radioButton2.AutoSize = true;
			this.radioButton2.Location = new System.Drawing.Point(265, 88);
			this.radioButton2.Name = "radioButton2";
			this.radioButton2.Size = new System.Drawing.Size(138, 24);
			this.radioButton2.TabIndex = 9;
			this.radioButton2.TabStop = true;
			this.radioButton2.Text = "Not From Origin";
			this.radioButton2.UseVisualStyleBackColor = true;
			// 
			// comboBox1
			// 
			this.comboBox1.FormattingEnabled = true;
			this.comboBox1.Location = new System.Drawing.Point(129, 188);
		...
		public RailObstacle finishObstacle;
		public RailPath rp;
	}
}